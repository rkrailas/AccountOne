            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="float-right">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="clearSelect2('inventoryac-dropdown'); 
                            clearSelect2('salesac-dropdown'); clearSelect2('purchasertac-dropdown'); clearSelect2('salesrtac-dropdown')">
