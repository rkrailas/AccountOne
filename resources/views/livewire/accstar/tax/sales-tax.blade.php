                    ...
                    <table class="table table-hover table-sm small">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">                                    
                                    สาขา
                                    <span wire:click="sortBy('customer.branchno')" class="float-right text-sm"
                                        style="cursor: pointer;">
                                        <i
                                            class="fa fa-xs fa-arrow-up {{ $sortBy === 'customer.branchno' && $sortDirection === 'asc' ? '' : 'text-muted'}}"></i>
                                        <i
                                            class="fa fa-xs fa-arrow-down {{ $sortBy === 'customer.branchno' && $sortDirection === 'desc' ? '' : 'text-muted'}}"></i>
                                    </span>
                                </th>
                            </tr>
                        </thead>
