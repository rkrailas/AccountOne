<div class="modal" id="returnGoodsForm" tabindex="-1" role="dialog" data-backdrop="static" wire:ignore.self>
        ...
        <form autocomplete="off" wire:submit.prevent="createUpdateSalesOrder">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-3">
                            <label class="">เลขที่รับคืน:</label>
                            <input type="text" class="form-control form-control-sm mb-1 @error('sonumber') is-invalid @enderror" required 
                                wire:model.defer="soHeader.sonumber">
                                @error('sonumber')
                        ...
                        <div class="col-3">
                            <label class="">วันที่รับคืน:</label>
...
@push('js')
<script>
    window.addEventListener('show-returnGoodsForm', event => {
        $('#returnGoodsForm').modal('show');
    })

    window.addEventListener('hide-returnGoodsForm', event => {
        $('#returnGoodsForm').modal('hide');
