<div>
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <!-- /.ปุ่มซ่อนเมนู -->
                    <h1 class="m-0 text-dark">ใบสั่งขาย</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <table class="table table-md table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">กำหนดส่งสินค้า
                                    <span wire:click="sortBy('a.deliverydate')" class="float-right text-sm" style="cursor: pointer;">
                                        <i class="fa fa-arrow-up {{ $sortBy === 'a.deliverydate' && $sortDirection === 'asc' ? '' : 'text-muted'}}"></i>
                                        <i class="fa fa-arrow-down {{ $sortBy === 'a.deliverydate' && $sortDirection === 'desc' ? '' : 'text-muted'}}"></i>
                                    </span>
                                </th>
                                ...
                                <th scope="col">ใบสั่งซื้อผู้ซื้อ
                                    <span wire:click="sortBy('a.refno')" class="float-right text-sm" style="cursor: pointer;">
                                        <i class="fa fa-arrow-up {{ $sortBy === 'a.refno' && $sortDirection === 'asc' ? '' : 'text-muted'}}"></i>
                                        <i class="fa fa-arrow-down {{ $sortBy === 'a.refno' && $sortDirection === 'desc' ? '' : 'text-muted'}}"></i>
                                    </span>
                                </th> 
    ...
    <!-- /.List Sales Order -->
    @include('livewire.sales._modal-sales-order')
