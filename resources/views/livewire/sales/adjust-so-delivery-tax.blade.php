<div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">เลขที่ปรับปรุง
                                    <span wire:click="sortBy('a.sonumber')" class="float-right text-sm" style="cursor: pointer;">
                                        <i class="fa fa-arrow-up {{ $sortBy === 'a.sonumber' && $sortDirection === 'asc' ? '' : 'text-muted'}}"></i>
                                        <i class="fa fa-arrow-down {{ $sortBy === 'a.sonumber' && $sortDirection === 'desc' ? '' : 'text-muted'}}"></i>
                                    </span>
                                </th>
                                <th scope="col">วันที่
    ...
    <!-- /.List Sales Order -->
    @include('livewire.sales._modal-adjust-so-delivery-tax')
