...
class AdjustSoDeliveryTax extends Component
{
    ...
    public function render()
    {
        ...
        // getSalesOrder
        $strsql = "SELECT a.id, a.snumber, a.sonumber, a.sodate, a.sototal, a.refno, b.customerid || ' : ' || b.name as name, a.transactiondate
            FROM sales a
            LEFT JOIN customer b ON a.customerid=b.customerid
            WHERE a.posted=false AND a.soreturn='D'
                AND a.sonumber IN (SELECT snumber FROM salesdetail WHERE quantitybac > 0 AND soreturn='D')
        ...
        return view('livewire.sales.adjust-so-delivery-tax', [
