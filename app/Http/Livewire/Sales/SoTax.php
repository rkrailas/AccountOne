...
class SoTax extends Component
{
    ...
    public function render()
    {
        ...
        $strsql = "SELECT a.id, a.snumber, a.sodate, a.sototal, b.customerid || ' : ' || b.name as name, a.transactiondate
            ...
            LEFT JOIN salesdetaillog c ON a.snumber=c.snumber
            WHERE c.soreturn='G' AND a.ram_sodeliverytax=false
        ...
        return view('livewire.sales.so-tax',[
