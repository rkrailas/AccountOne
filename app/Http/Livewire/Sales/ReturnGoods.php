...
class ReturnGoods extends Component
{
    ...
    public function render()
    {
        ...
        $strsql = "SELECT a.id, a.snumber, a.sonumber, a.sodate, a.sototal, a.refno, b.customerid || ' : ' || b.name as name, a.transactiondate
            ...
            WHERE a.posted=false AND a.soreturn='Y'
                AND a.sonumber IN (SELECT snumber FROM salesdetail WHERE quantitybac > 0 AND soreturn='Y')
        ...
        return view('livewire.sales.return-goods', [
