...
class CancelSoTax extends Component
{
    ...
    public function searchDoc()
    {
        $strsql = "select sales.snumber,to_char(sales.sodate,'YYYY-MM-DD') as sodate, sales.deliveryno, to_char(sales.deliverydate,'YYYY-MM-DD') as deliverydate
                ...
                join taxdata on salesdetaillog.taxnumber = taxdata.taxnumber
                where salesdetaillog.soreturn='N' and sales.ram_sodeliverytax=false and sales.posted=true and taxdata.iscancelled=false
    ...
    public function render()
    {
        ...
        return view('livewire.sales.cancel-so-tax');
    }
}
